...
$( document ).ready(function() {
  ...
  var data = "data/data2016.csv";//var data = "data/" + data2016.csv;

  d3.selectAll("#TreatmentType").on("change",wasClicked);
        wasClicked();

  d3.selectAll("#TissueType").on("change",wasClicked);
        wasClicked();
        
  d3.selectAll("#dataSources").on("change",wasClicked);
        wasClicked();

  function wasClicked(){
    var dropdown = $('#dataSources option:selected').text();
    var data1 = "data/" + dropdown;
    update(data1);
  }
  ...
  function update(dataString){
    ...
    d3.csv(dataString, function(error, mfi) {
